    ...
    public function item_update(Request $request)
    {
        ...
        if($request->person_photo != null) {
            ...
            if($obj->person_photo!=null) {
                unlink(('uploads/'.$obj->person_photo));
            }
            
            $final_name = 'welcome_one_person_photo_'.time().'.'.$request->person_photo->extension();
            $request->person_photo->move(('uploads'), $final_name);
        ...
        $obj->person_designation_ar = $request->person_designation_ar;
        $obj->person_designation_krd = $request->person_designation_krd;

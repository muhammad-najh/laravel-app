...
class AdminOtherPageItemController extends Controller
{
    ...
    public function about_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_about_team_members_heading_krd = $request->page_about_team_members_heading_krd;
        $obj->page_about_team_members_heading_ar = $request->page_about_team_members_heading_ar;
        $obj->page_about_team_members_subheading_ar = $request->page_about_team_members_subheading_ar;
        $obj->page_about_team_members_subheading_krd = $request->page_about_team_members_subheading_krd;

        $obj->page_about_title_ar = $request->page_about_title_ar;
        $obj->page_about_title_krd = $request->page_about_title_krd;
        $obj->page_about_service_heading_ar = $request->page_about_service_heading_ar;
        $obj->page_about_service_heading_krd = $request->page_about_service_heading_krd;
        $obj->page_about_service_subheading_ar = $request->page_about_service_subheading_ar;
        
           $obj->com_hir = $request->com_hir;
           
           
           if ($request->hasFile('com_hir_url')) {

      if($request->com_hir_url != null) {
            $request->validate([
            ...
            $final_name = 'com_hirarcy_'.time().'.'.$request->com_hir_url->extension();
            $request->com_hir_url->move(('uploads'), $final_name);
            $obj->com_hir_url = $final_name;
        }
           }
        ...
        $obj->page_about_service_subheading_krd = $request->page_about_service_subheading_krd;
        $obj->page_about_service_text_ar = $request->page_about_service_text_ar;
        $obj->page_about_service_text_krd = $request->page_about_service_text_krd;
    ...
    public function team_member_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_team_members_title_ar = $request->page_team_members_title_ar;
        $obj->page_team_members_title_krd = $request->page_team_members_title_krd;
        $obj->page_about_team_members_subheading_ar = $request->page_about_team_members_subheading_ar;
        $obj->page_about_team_members_subheading_krd = $request->page_about_team_members_subheading_krd;
        $obj->page_about_team_members_heading_ar = $request->page_about_team_members_heading_ar;
        $obj->page_about_team_members_heading_krd = $request->page_about_team_members_heading_krd;
    ...
    public function testimonial_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_testimonials_title_ar = $request->page_testimonials_title_ar;
        $obj->page_testimonials_title_krd = $request->page_testimonials_title_krd;
    ...
    public function pricing_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_pricing_title_ar = $request->page_pricing_title_ar;
        $obj->page_pricing_title_krd = $request->page_pricing_title_krd;
    ...
    public function faq_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_faq_title_ar = $request->page_faq_title_ar;
        $obj->page_faq_title_krd = $request->page_faq_title_krd;
    ...
    public function services_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_services_title_ar = $request->page_services_title_ar;
        $obj->page_services_title_krd = $request->page_services_title_krd;
    ...
    public function portfolios_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_portfolios_title_ar = $request->page_portfolios_title_ar;
        $obj->page_portfolios_title_krd = $request->page_portfolios_title_krd;
    ...
    public function blog_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_blog_title_ar = $request->page_blog_title_ar;
        $obj->page_blog_title_krd = $request->page_blog_title_krd;
    ...
    public function contact_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_contact_info_address_title_ar = $request->page_contact_info_address_title_ar;
        $obj->page_contact_info_address_title_krd = $request->page_contact_info_address_title_krd;
        $obj->page_contact_info_email_title_ar = $request->page_contact_info_email_title_ar;
        $obj->page_contact_info_email_title_krd = $request->page_contact_info_email_title_krd;
        $obj->page_contact_info_email_title_ar = $request->page_contact_info_email_title_ar;
        $obj->page_contact_info_email_title_krd = $request->page_contact_info_email_title_krd;


        $obj->page_contact_title_ar = $request->page_contact_title_ar;
        $obj->page_contact_title_krd = $request->page_contact_title_krd;
        $obj->page_contact_send_mail_heading_ar = $request->page_contact_send_mail_heading_ar;
        $obj->page_contact_send_mail_heading_krd = $request->page_contact_send_mail_heading_krd;
        $obj->page_contact_send_mail_subheading_ar = $request->page_contact_send_mail_subheading_ar;
        $obj->page_contact_send_mail_subheading_krd = $request->page_contact_send_mail_subheading_krd;
        $obj->page_contact_info_heading_ar = $request->page_contact_info_heading_ar;
        $obj->page_contact_info_heading_krd = $request->page_contact_info_heading_krd;
        $obj->page_contact_info_subheading_ar = $request->page_contact_info_subheading_ar;
        $obj->page_contact_info_subheading_krd = $request->page_contact_info_subheading_krd;
        $obj->page_contact_info_text_ar = $request->page_contact_info_text_ar;
        $obj->page_contact_info_text_krd = $request->page_contact_info_text_krd;

        $obj->page_contact_info_q_title_ar = $request->page_contact_info_q_title_ar;
        $obj->page_contact_info_q_title_krd = $request->page_contact_info_q_title_krd;
        $obj->page_contact_info_q_title = $request->page_contact_info_q_title;
    ...
    public function terms_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_terms_title_ar = $request->page_terms_title_ar;
        $obj->page_terms_title_krd = $request->page_terms_title_krd;
        $obj->page_terms_content_ar = $request->page_terms_content_ar;
        $obj->page_terms_content_krd = $request->page_terms_content_krd;
    ...
    public function privacy_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_privacy_title_ar = $request->page_privacy_title_ar;
        $obj->page_privacy_title_krd = $request->page_privacy_title_krd;
        $obj->page_privacy_content_ar = $request->page_privacy_content_ar;
        $obj->page_privacy_content_krd = $request->page_privacy_content_krd;
    ...
    public function search_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_search_seo_title_ar = $request->page_search_seo_title_ar;
        $obj->page_search_seo_title_krd = $request->page_search_seo_title_krd;
        $obj->page_search_seo_meta_description_ar = $request->page_search_seo_meta_description_ar;
        $obj->page_search_seo_meta_description_krd = $request->page_search_seo_meta_description_krd;
    ...
    public function tag_update(Request $request)
    {
        ...
        // Handle new columns
        $obj->page_tag_seo_title_ar = $request->page_tag_seo_title_ar;
        $obj->page_tag_seo_title_krd = $request->page_tag_seo_title_krd;
        $obj->page_tag_seo_meta_description_ar = $request->page_tag_seo_meta_description_ar;
        $obj->page_tag_seo_meta_description_krd = $request->page_tag_seo_meta_description_krd;

...
<section class="banner-section">
    ...
    @php
        // Determine the current language; adjust this to your application's language logic
        $currentLanguage = session('sess_lang_code', 'en'); // Default to 'en' (English) if no language is set
        
        // Load the appropriate text based on the current language
        switch ($currentLanguage) {
            case 'ar':

                $text = $slider->text_ar;
                $btn_text=$slider->button_text_ar;
                break;
            case 'krd':
                $text = $slider->text_krd;
                $btn_text=$slider->button_text_krd;

                break;
            default:
                $text = $slider->text;
                $btn_text=$slider->button_text;
    ...
    @if($text)
        <h1 class="title animate-1">
            {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($text))) !!}
        </h1>
    @endif
    ...
    @if($slider->button_text != '')
        <div class="btn-box animate-2">
            <a href="{{ $slider->button_url }}" class="theme-btn btn-style-one hover-light">
                <span class="btn-title">            {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($btn_text))) !!}</span>
            </a>
        </div>
    @endif
</div>
...
<section class="services-section-two border-top-1 bg-f7">
    ...
    <div class="inner-box">
        ...
        <img class="rounded-circle" alt="Avatar" src="{{ asset('uploads/' . $service->icon) }}" style="width: 80px; height: 80px;">

        <span class="count"><em>{{ $num }}</em></span>
        <i class="icon {{ $service->icon }}"></i>
        <h4 class="title"><a href="{{ route('servicesdetail', ['category' => $service->category, 'id' => $service->id]) }}">{{ $service->name }}</a></h4>
                    ...
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="sub-title">
                                @if($currentLanguage == 'ar')
                                    {{ $welcome_two_items->subheading_ar }}
                                @elseif($currentLanguage == 'krd')
                                    {{ $welcome_two_items->subheading_krd }}
                                @else
                            ...
                            <h2>
                                @if($currentLanguage == 'ar')
                                    {{ $welcome_two_items->heading_ar }}
                                @elseif($currentLanguage == 'krd')
                                    {{ $welcome_two_items->heading_krd }}
                                @else
                            ...
                            <div class="text">
                                @if($currentLanguage == 'ar')
                                    {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($welcome_two_items->text_ar))) !!}
                                @elseif($currentLanguage == 'krd')
                                    {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($welcome_two_items->text_krd))) !!}
                                @else
                        ...
                        <div class="row">
                            ...
                            <div class="info-box col-lg-6 col-md-6">
                                <div class="inner">
                                    <h5 class="title">
                                        <i class="icon fa @if(session('sess_lang_direction') == 'Right to Left (RTL)') fa-circle-arrow-left @else fa-circle-arrow-right @endif"></i>
                                        @if($currentLanguage == 'ar')
                                            {{ $item->heading_ar }}
                                        @elseif($currentLanguage == 'krd')
                                            {{ $item->heading_krd }}
                                    ...
                                    <div class="bar-inner">
                                        <div class="bar progress-line" data-width="{{ $item->percentage }}">
                                            <div class="skill-percentage">
                                                <div class="count-box">
                                                    <span class="count-text" data-speed="3000" data-stop="{{ $item->percentage }}">0</span>%
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!--    <a href="{{ $welcome_two_items->button_url }}" class="theme-btn btn-style-one hvr-dark">-->
                        <!--        <span class="btn-title">-->
                              
                        <!--                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($btn_text))) !!}-->
            ...
            <div class="content-column position-relative col-lg-6 col-md-12">
                <div class="inner-column">
                    <div class="sec-title light">
                        <span class="sub-title">
                            @if($currentLanguage == 'ar')
                                {{ $offers->subheading_ar }}
                            @elseif($currentLanguage == 'krd')
                                {{ $offers->subheading_krd }}
                            @else
                                {{ $offers->subheading }}
                            @endif
                        </span>
                        ...
                        <div class="text">
                            @if($currentLanguage == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($offers->text_ar))) !!}
                            @elseif($currentLanguage == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($offers->text_krd))) !!}
                            @else
                    ...
                    <div class="info-box">
                        ...
                        <h5 class="title">
                            @if($currentLanguage == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($offers->tagline_ar))) !!}
                            @elseif($currentLanguage == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($offers->tagline_krd))) !!}
                            @else
                    ...
                    <div class="col-lg-7">
                        <span class="sub-title">
                            @if(session('sess_lang_code') == 'ar')
                                {{ $home_3_page_items->portfolio_subheading_ar }}
                            @elseif(session('sess_lang_code') == 'krd')
                                {{ $home_3_page_items->portfolio_subheading_krd }}
                            @else
                        ...
                        <h2>
                            @if(session('sess_lang_code') == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_heading_ar))) !!}
                            @elseif(session('sess_lang_code') == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_heading_krd))) !!}
                            @else
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_heading))) !!}
                            @endif
                        </h2>
                    </div>
                    <div class="col-lg-5">
                        <div class="text">
                            @if(session('sess_lang_code') == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_text_ar))) !!}
                            @elseif(session('sess_lang_code') == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_text_krd))) !!}
                            @else
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->portfolio_text))) !!}
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-outer">
                    <div class="projects-carousel-home4 owl-carousel owl-theme default-navs">
                        ...
                        <div class="project-block-home4">
                            <div class="image-box">
                                <figure class="image">
                                    <a href="{{ asset('uploads/'.$portfolio->photo) }}" class="lightbox-image">
                                        <img src="{{ asset('uploads/'.$portfolio->photo) }}" alt="">
                                    </a>
                                </figure>
            ...
            <div class="title-column col-lg-6 col-md-12">
                <div class="inner-column">
                    <div class="sec-title light">
                        <span class="sub-title">
                            @if(session('sess_lang_code') == 'ar')
                                {{ $feature_two_items->subheading_ar }}
                            @elseif(session('sess_lang_code') == 'krd')
                                {{ $feature_two_items->subheading_krd }}
                            @else
                        ...
                        <h2>
                            @if(session('sess_lang_code') == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($feature_two_items->heading_ar))) !!}
                            @elseif(session('sess_lang_code') == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($feature_two_items->heading_krd))) !!}
                            @else
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($feature_two_items->heading))) !!}
                            @endif
                        </h2>
                    </div>
                    <div class="info-box">
                        <figure class="image">
                            <img src="{{ asset('uploads/'.$feature_two_items->photo) }}" alt="">
                        </figure>
                        <div class="text">
                            @if(session('sess_lang_code') == 'ar')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($feature_two_items->text_ar))) !!}
                            @elseif(session('sess_lang_code') == 'krd')
                                {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($feature_two_items->text_krd))) !!}
                            @else
...
<section class="clients-section">
    <div class="auto-container">
        <!-- Our Clients Heading -->
        <div class="clients-heading" style="text-align: center; margin: 30px 0 20px 0;"> <!-- Adjusted top margin -->
    ...
    <div class="auto-container">
        <div class="outer-box wow fadeIn">
            ...
            <div class="title-box">
                <h4 class="title">
                    @if(session('sess_lang_code') == 'ar')
                        {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($call_to_action->text_ar))) !!}
                    @elseif(session('sess_lang_code') == 'krd')
                        {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($call_to_action->text_krd))) !!}
                    @else
            ...
            <div class="info-box">
                ...
                <a href="tel:{{ $call_to_action->phone }}" class="num">{{ $call_to_action->phone1 }}</a>
...
<section class="clients-section">
    <div class="auto-container">
        <!-- Our Clients Heading -->
        <div class="clients-heading" style="text-align: center; margin: 30px 0 20px 0;"> <!-- Adjusted top margin -->
            <h2 style="margin: 0;">Our Clients</h2>
        </div>
...
<section class="team-section bg-f7 pb-30">
    <div class="auto-container">
        <div class="sec-title text-center">
            <span class="sub-title">
            @if(session('sess_lang_code') == 'ar')
             {{ $home_3_page_items->team_member_subheading_ar }}
             @elseif(session('sess_lang_code') == 'krd')
             {{ $home_3_page_items->team_member_subheading_krd }}
             @else
            ...
            @if(session('sess_lang_code') == 'ar')
             {{ $home_3_page_items->team_member_heading_ar }}
             @elseif(session('sess_lang_code') == 'krd')
             {{ $home_3_page_items->team_member_heading_krd }}
             @else
             {{ $home_3_page_items->team_member_heading }}
             @endif
            </h2>
        </div>
            ...
            <div class="form-column col-lg-7 col-md-12">
                <div class="inner-column">
                    <div class="sec-title light">
                        <span class="sub-title">                
                        @if(session('sess_lang_code') == 'ar')
                          {{ $home_3_page_items->contact_subheading_ar }}
                         @elseif(session('sess_lang_code') == 'krd')
                         {{ $home_3_page_items->contact_subheading_krd }}
                        @else
                        ...
                        <h2>
                        @if(session('sess_lang_code') == 'ar')
                        {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->contact_heading_ar))) !!}
                         @elseif(session('sess_lang_code') == 'krd')
                         {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->contact_heading_krd))) !!}
                        @else
                        {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_3_page_items->contact_heading))) !!}
                         @endif 

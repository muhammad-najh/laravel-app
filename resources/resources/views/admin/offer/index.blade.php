            ...
            <div class="card-body">
                <form action="{{ route('admin_offer_update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="heading_krd" class="form-control" value="{{ $offers->heading_krd }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Heading AR') }}</label>
                        <input type="text" name="heading_ar" class="form-control" value="{{ $offers->heading_ar }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subheading_krd" class="form-control" value="{{ $offers->subheading_krd }}">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Subheading AR') }}</label>
                        <input type="text" name="subheading_ar" class="form-control" value="{{ $offers->subheading_ar }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="text_krd" class="form-control h_100" cols="30" rows="10">{{ $offers->text_krd }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Text AR') }}</label>
                        <textarea name="text_ar" class="form-control h_100" cols="30" rows="10">{{ $offers->text_ar }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Tagline KRD') }}</label>
                        <textarea name="tagline_krd" class="form-control h_100" cols="30" rows="10">{{ $offers->tagline_krd }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Tagline AR') }}</label>
                        <textarea name="tagline_ar" class="form-control h_100" cols="30" rows="10">{{ $offers->tagline_ar }}</textarea>
                    </div>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin_offer_element_update',$item->id) }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <br>
                                                    <input type="text" name="item_krd" class="form-control" value="{{ $item->item_krd }}" required>
                                                    <br>
                                                    <input type="text" name="item_ar" class="form-control" value="{{ $item->item_ar }}" required>

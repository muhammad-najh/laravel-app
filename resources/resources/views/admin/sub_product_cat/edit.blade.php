...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">{{ __('Edit Sub Product Category') }}</h1>
    <a href="{{ route('admin_product_cat_index_sub') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm"><i class="fas fa-bars"></i> {{ __('All Items') }}
    </a>
</div>

<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('admin_product_cat_update_sub',$subcategory->id) }}" method="post">
            @csrf
            <div class="mb-3">

...
use App\Http\Controllers\Admin\MyAdminServiceCategoryController;
use App\Http\Controllers\Admin\MyAdminProductCategoryController;
...
Route::get('/service/{id}', [FrontController::class, 'myService'])->name('service');
Route::post('/services', [FrontController::class, 'MyService'])->name('service');

Route::get('/service/{slug}', [FrontController::class, 'service'])->name('servicedetail');
Route::get('/servicecat/{category_name}/{sub_cat_id}', [FrontController::class, 'servicecat'])->name('servicecat');
Route::get('/servicesdetail/{id}/{category}', [FrontController::class, 'serviceByCategory'])->name('servicesdetail');


Route::get('/product/{id}', [FrontController::class, 'myProduct'])->name('product');
Route::post('/products', [FrontController::class, 'MyProduct'])->name('product');
Route::get('/product/{slug}', [FrontController::class, 'product'])->name('productdetail');

Route::get('/productcat/{category_name}/{subcategory_name}/{sub_cat_id}', [FrontController::class, 'productcat'])->name('productcat');
Route::get('/productdetail/{id}/{category}', [FrontController::class, 'productByCategory'])->name('productsdetail');
...
Route::middleware('admin')->prefix('admin')->group(function () {
      ...
      Route::get('/partner/index', [AdminContactUsController::class, 'index_partner'])->name('admin_partner_index');
      
       Route::get('/partner/create', [AdminContactUsController::class, 'create_partner'])->name('admin_partner_create');
 
        
    Route::post('/partner/store', [AdminContactUsController::class, 'store_partner'])->name('admin_partner_store');
    
    Route::get('/partner/edit/{id}', [AdminContactUsController::class, 'edit_partner'])->name('admin_partner_edit');
    
    Route::post('/partner/update/{id}', [AdminContactUsController::class, 'update_partner'])->name('admin_partner_update');
    
    Route::get('/partner/destroy/{id}', [AdminContactUsController::class, 'destroy_partner'])->name('admin_partner_destroy');
    
    
    
       // Contact Routes
    Route::get('/contact/index', [AdminContactUsController::class, 'index'])->name('admin_contact_us_index');
    
    Route::get('/contact/create', [AdminContactUsController::class, 'create'])->name('admin_contact_us_create');
    Route::post('/contact/store', [AdminContactUsController::class, 'store'])->name('admin_contact_us_store');
    Route::get('/contact/edit/{id}', [AdminContactUsController::class, 'edit'])->name('admin_contact_us_edit');
    Route::post('/contact/update/{id}', [AdminContactUsController::class, 'update'])->name('admin_contact_us_update');
    Route::get('/contact/destroy/{id}', [AdminContactUsController::class, 'destroy'])->name('admin_contact_us_destroy');
    ...
    Route::get('/product/destroy/{id}', [AdminProductController::class, 'destroy'])->name('admin_product_destroy');
    Route::get('/product/destroy-banner/{id}', [AdminProductController::class, 'destroy_banner'])->name('admin_product_destroy_banner');
    Route::get('/product/destroy-pdf/{id}', [AdminProductController::class, 'destroy_pdf'])->name('admin_product_destroy_pdf');
    Route::get('/product/faq/{id}', [AdminProductController::class, 'product_faq'])->name('admin_product_faq');
    Route::post('/product/faq/store/{product_id}', [AdminProductController::class, 'product_faq_store'])->name('admin_product_faq_store');
    Route::post('/product/faq/update/{faq_id}', [AdminProductController::class, 'product_faq_update'])->name('admin_product_faq_update');
    Route::get('/product/faq/destroy/{faq_id}', [AdminProductController::class, 'product_faq_destroy'])->name('admin_product_faq_destroy');
    ...
    Route::get('/service/cat/index',[MyAdminServiceCategoryController::class,'index'])->name('admin_service_cat_index');
    Route::get('/service/cat/edit/{id}',[MyAdminServiceCategoryController::class,'edit'])->name('admin_service_cat_edit');
    Route::post('/service/cat/update/{id}',[MyAdminServiceCategoryController::class,'update'])->name('admin_service_cat_update');


    Route::get('/service/cat/create',[MyAdminServiceCategoryController::class,'create'])->name('admin_service_cat_create');
    Route::post('/service/cat/store',[MyAdminServiceCategoryController::class,'store'])->name('admin_service_cat_store');
    Route::get('/service/cat/destroy/{id}',[MyAdminServiceCategoryController::class,'destroy'])->name('admin_service_cat_destory');

    Route::get('/service/subcat/index',[MyAdminServiceCategoryController::class,'index_sub'])->name('admin_service_cat_index_sub');
    Route::get('/service/subcat/edit/{id}',[MyAdminServiceCategoryController::class,'edit_sub'])->name('admin_service_cat_edit_sub');
    Route::post('/service/subcat/update/{id}',[MyAdminServiceCategoryController::class,'upate_sub'])->name('admin_service_cat_update_sub');

    Route::get('/service/subcat/create',[MyAdminServiceCategoryController::class,'create_sub'])->name('admin_service_cat_create_sub');
    Route::post('/service/subcat/store',[MyAdminServiceCategoryController::class,'store_sub'])->name('admin_service_cat_store_sub');
    Route::get('/service/subcat/destroy/{id}',[MyAdminServiceCategoryController::class,'destroy_sub'])->name('admin_service_cat_destory_sub');

    Route::get('/product/{id}', [MyAdminProductCategoryController::class, 'show'])->name('product');

    Route::get('/product/cat/index', [MyAdminProductCategoryController::class, 'index'])->name('admin_product_cat_index');
    Route::get('/product/cat/edit/{id}', [MyAdminProductCategoryController::class, 'edit'])->name('admin_product_cat_edit');
    Route::post('/product/cat/update/{id}', [MyAdminProductCategoryController::class, 'update'])->name('admin_product_cat_update');
    Route::get('/product/cat/create', [MyAdminProductCategoryController::class, 'create'])->name('admin_product_cat_create');
    Route::post('/product/cat/store', [MyAdminProductCategoryController::class, 'store'])->name('admin_product_cat_store');
    Route::get('/product/cat/destroy/{id}', [MyAdminProductCategoryController::class, 'destroy'])->name('admin_product_cat_destroy');
    
    Route::get('/product/subcat/index', [MyAdminProductCategoryController::class, 'index_sub'])->name('admin_product_cat_index_sub');
    Route::get('/product/subcat/edit/{id}', [MyAdminProductCategoryController::class, 'edit_sub'])->name('admin_product_cat_edit_sub');
    Route::post('/product/subcat/update/{id}', [MyAdminProductCategoryController::class, 'update_sub'])->name('admin_product_cat_update_sub');
    Route::get('/product/subcat/create', [MyAdminProductCategoryController::class, 'create_sub'])->name('admin_product_cat_create_sub');
    Route::post('/product/subcat/store', [MyAdminProductCategoryController::class, 'store_sub'])->name('admin_product_cat_store_sub');
    Route::get('/product/subcat/destroy/{id}', [MyAdminProductCategoryController::class, 'destroy_sub'])->name('admin_product_cat_destroy_sub');
    ...
    Route::get('/service/pdf/{id}',[AdminServiceController::class,'service_pdf'])->name('admin_service_pdf');
    Route::post('/service/pdf/store/{service_id}',[AdminServiceController::class,'service_pdf_store'])->name('admin_service_pdf_store');
    Route::post('/service/pdf/update/{faq_id}',[AdminServiceController::class,'service_pdf_update'])->name('admin_service_pdf_update');
    Route::get('/service/pdf/destroy/{faq_id}',[AdminServiceController::class,'service_pdf_destroy'])->name('admin_service_pdf_destroy');
   
    Route::get('/product/pdf/{id}',[AdminProductController::class,'product_pdf'])->name('admin_product_pdf');
    Route::post('/product/pdf/store/{service_id}',[AdminProductController::class,'product_pdf_store'])->name('admin_product_pdf_store');
    Route::post('/product/pdf/update/{faq_id}',[AdminProductController::class,'product_pdf_update'])->name('admin_product_pdf_update');
    Route::get('/product/pdf/destroy/{faq_id}',[AdminProductController::class,'product_pdf_destroy'])->name('admin_product_pdf_destroy');

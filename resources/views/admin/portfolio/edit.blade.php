    ...
    <div class="card-body">
        <form action="{{ route('admin_portfolio_update',$portfolio->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('NameAR') }} *</label>
                        <input type="text" name="name_ar" class="form-control" value="{{ $portfolio->name_ar }}">
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('NameKRD') }} *</label>
                        <input type="text" name="name_krd" class="form-control" value="{{ $portfolio->name_krd }}">
                    </div>
                </div>
            ...
            <div class="mb-3">
                <label for="" class="form-label">{{ __('DescriptionAR') }} * </label>
                <textarea name="description_ar" class="form-control editor" cols="30" rows="10">{{ $portfolio->description_ar }}</textarea>
            </div>
            <div class="mb-3">
                <label for="" class="form-label">{{ __('DescriptionKRD') }} * </label>
                <textarea name="description_krd" class="form-control editor" cols="30" rows="10">{{ $portfolio->description_krd }}</textarea>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">

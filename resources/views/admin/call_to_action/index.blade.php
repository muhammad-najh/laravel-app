            ...
            <div class="card-body">
                <form action="{{ route('admin_call_to_action_update') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="text_ar" class="form-control h_100" cols="30" rows="10">{{ $call_to_action->text_ar }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Text KRD') }}</label>
                        <textarea name="text_krd" class="form-control h_100" cols="30" rows="10">{{ $call_to_action->text_krd }}</textarea>
                    </div>

                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="" class="form-label">{{ __('Phone1') }}</label>
                                <input type="text" name="phone" class="form-control" value="{{ $call_to_action->phone }}">
                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label">{{ __('Phone2') }}</label>
                                <input type="text" name="phone1" class="form-control" value="{{ $call_to_action->phone1 }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">

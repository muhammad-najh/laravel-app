...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('admin_service_cat_index_sub') }}" class="d-none d-sm-inline-block btn btn-primary shadow-sm">
...
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('admin_service_cat_store_sub') }}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="service_id" class="form-control" required>
                            ...
                            @foreach($serviceCategories as $category)
                                <option name="service_id" value="{{ $category->id }}">{{ $category->name_en }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

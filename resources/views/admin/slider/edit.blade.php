            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="text_krd" class="form-control h_100" cols="30" rows="10">{{ $slider->text_krd }}</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Text AR') }}</label>
                        <textarea name="text_ar" class="form-control h_100" cols="30" rows="10">{{ $slider->text_ar }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text AR" name="button_text_ar" class="form-control" value="{{ $slider->button_text_ar }}">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Button Text KRD') }}</label>
                        <input type="text_krd" name="button_text_krd" class="form-control" value="{{ $slider->button_text_krd }}">
                    </div>

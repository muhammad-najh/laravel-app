                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    ...
                                    <form action="{{ route('admin_other_page_item_about_update') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Company hierarchy') }}</label>
                                            <select name="com_hir" class="form-select">
                                                <option value="Show" @if($other_page_items->com_hir == 'Show') selected @endif>{{ __('Show') }}</option>
                                                <option value="Hide" @if($other_page_items->com_hir == 'Hide') selected @endif>{{ __('Hide') }}</option>
                                            </select>
                                            
<div class="mb-3">
    <label for="com_hir_url" class="form-label">{{ __('Upload Company Hierarchy Image') }}</label>
    <input type="file" name="com_hir_url" class="form-control" id="com_hir_url" accept=".png,.jpg,.jpeg">
</div>
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_about_title_ar" class="form-control" value="{{ $other_page_items->page_about_title_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_about_title_krd" class="form-control" value="{{ $other_page_items->page_about_title_krd }}">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - Heading AR') }}</label>
                                            <textarea name="page_about_service_heading_ar" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_service_heading_ar }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - Heading KRD') }}</label>
                                            <textarea name="page_about_service_heading_krd" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_service_heading_krd }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - SubHeading AR') }}</label>
                                            <input type="text" name="page_about_service_subheading_ar" class="form-control" value="{{ $other_page_items->page_about_service_subheading_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - SubHeading KRD') }}</label>
                                            <input type="text" name="page_about_service_subheading_krd" class="form-control" value="{{ $other_page_items->page_about_service_subheading_krd }}">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - Text AR') }}</label>
                                            <textarea name="page_about_service_text_ar" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_service_text_ar }}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Service - Text KRD') }}</label>
                                            <textarea name="page_about_service_text_krd" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_service_text_krd }}</textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Team Members - Heading AR') }}</label>
                                            <textarea name="page_about_team_members_heading_ar" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_team_members_heading_ar }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Team Members - Heading KRD') }}</label>
                                            <textarea name="page_about_team_members_heading_krd" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_about_team_members_heading_krd }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Team Members - SubHeading AR') }}</label>
                                            <input type="text" name="page_about_team_members_subheading_ar" class="form-control" value="{{ $other_page_items->page_about_team_members_subheading_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Team Members - SubHeading KRD') }}</label>
                                            <input type="text" name="page_about_team_members_subheading_krd" class="form-control" value="{{ $other_page_items->page_about_team_members_subheading_krd }}">
                                        </div>
                                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_team_member_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_team_members_title_ar" class="form-control" value="{{ $other_page_items->page_team_members_title_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_team_members_title_krd" class="form-control" value="{{ $other_page_items->page_team_members_title_krd }}">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_testimonial_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_testimonials_title_ar" class="form-control" value="{{ $other_page_items->page_testimonials_title_ar }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_testimonials_title_krd" class="form-control" value="{{ $other_page_items->page_testimonials_title_krd }}">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_faq_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_faq_title_ar" class="form-control" value="{{ $other_page_items->page_faq_title_ar }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_faq_title_krd" class="form-control" value="{{ $other_page_items->page_faq_title_krd }}">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_services_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_services_title_ar" class="form-control" value="{{ $other_page_items->page_services_title_ar }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_services_title_krd" class="form-control" value="{{ $other_page_items->page_services_title_krd }}">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_portfolios_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_portfolios_title_ar" class="form-control" value="{{ $other_page_items->page_portfolios_title_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_portfolios_title_krd" class="form-control" value="{{ $other_page_items->page_portfolios_title_krd }}">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_contact_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_contact_title_ar" class="form-control" value="{{ $other_page_items->page_contact_title_ar }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_contact_title_krd" class="form-control" value="{{ $other_page_items->page_contact_title_krd }}">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Send Mail Heading AR') }}</label>
                                                    <input type="text" name="page_contact_send_mail_heading_ar" class="form-control" value="{{ $other_page_items->page_contact_send_mail_heading_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Send Mail Heading KRD') }}</label>
                                                    <input type="text" name="page_contact_send_mail_heading_krd" class="form-control" value="{{ $other_page_items->page_contact_send_mail_heading_krd }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Send Mail Subheading AR') }}</label>
                                                    <input type="text" name="page_contact_send_mail_subheading_ar" class="form-control" value="{{ $other_page_items->page_contact_send_mail_subheading_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Send Mail Subheading KRD') }}</label>
                                                    <input type="text" name="page_contact_send_mail_subheading_krd" class="form-control" value="{{ $other_page_items->page_contact_send_mail_subheading_krd }}">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Heading AR') }}</label>
                                                    <input type="text" name="page_contact_info_heading_ar" class="form-control" value="{{ $other_page_items->page_contact_info_heading_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Heading KRD') }}</label>
                                                    <input type="text" name="page_contact_info_heading_krd" class="form-control" value="{{ $other_page_items->page_contact_info_heading_krd }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - SubHeading AR') }}</label>
                                                    <input type="text" name="page_contact_info_subheading_ar" class="form-control" value="{{ $other_page_items->page_contact_info_subheading_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - SubHeading KRD') }}</label>
                                                    <input type="text" name="page_contact_info_subheading_krd" class="form-control" value="{{ $other_page_items->page_contact_info_subheading_krd }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Information - Text AR') }}</label>
                                            <textarea name="page_contact_info_text_ar" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_contact_info_text_ar }}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Information - Text KRD') }}</label>
                                            <textarea name="page_contact_info_text_krd" class="form-control h_100" cols="30" rows="10">{{ $other_page_items->page_contact_info_text_krd}}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="page_contact_info_q_title" class="form-control" value="{{ $other_page_items->page_contact_info_q_title }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Phone Titl AR') }}</label>
                                                    <input type="text" name="page_contact_info_q_title_ar" class="form-control" value="{{ $other_page_items->page_contact_info_q_title_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Phone Title KRD') }}</label>
                                                    <input type="text" name="page_contact_info_q_title_krd" class="form-control" value="{{ $other_page_items->page_contact_info_q_title_krd }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Email Title AR') }}</label>
                                                    <input type="text" name="page_contact_info_email_title_ar" class="form-control" value="{{ $other_page_items->page_contact_info_email_title_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Email Title KRD') }}</label>
                                                    <input type="text" name="page_contact_info_email_title_krd" class="form-control" value="{{ $other_page_items->page_contact_info_email_title_krd }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Address Title AR') }}</label>
                                                    <input type="text" name="page_contact_info_address_title_ar" class="form-control" value="{{ $other_page_items->page_contact_info_address_title_ar }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Information - Address Title KRD') }}</label>
                                                    <input type="text" name="page_contact_info_address_title_krd" class="form-control" value="{{ $other_page_items->page_contact_info_address_title_krd }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 gap-1">
                                    <form action="{{ route('admin_other_page_item_terms_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_terms_title_ar" class="form-control" value="{{ $other_page_items->page_terms_title_ar }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_terms_title_krd" class="form-control" value="{{ $other_page_items->page_terms_title_krd }}">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Content AR') }}</label>
                                            <textarea name="page_terms_content_ar" class="form-control editor" cols="30" rows="10">{{ $other_page_items->page_terms_content_ar }}</textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Content KRD') }}</label>
                                            <textarea name="page_terms_content_krd" class="form-control editor" cols="30" rows="10">{{ $other_page_items->page_terms_content_krd }}</textarea>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 mb-3">
                                    <form action="{{ route('admin_other_page_item_privacy_update') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title AR') }}</label>
                                            <input type="text" name="page_privacy_title_ar" class="form-control" value="{{ $other_page_items->page_privacy_title_ar }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Title KRD') }}</label>
                                            <input type="text" name="page_privacy_title_krd" class="form-control" value="{{ $other_page_items->page_privacy_title_krd }}">
                                        </div>

                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Content EN') }}</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Content AR') }}</label>
                                            <textarea name="page_privacy_content_ar" class="form-control editor" cols="30" rows="10">{{ $other_page_items->page_privacy_content_ar }}</textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="" class="form-label">{{ __('Content KRD') }}</label>
                                            <textarea name="page_privacy_content_krd" class="form-control editor" cols="30" rows="10">{{ $other_page_items->page_privacy_content_krd }}</textarea>
                                        </div>

        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route('admin_welcome_one_item_update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('HeadingAR') }}</label>
                        <input type="text" name="heading_ar" class="form-control" value="{{ $welcome_one_items->heading_ar }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('HeadingKRD') }}</label>
                        <input type="text" name="heading_krd" class="form-control" value="{{ $welcome_one_items->heading_krd }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('SubheadingAR') }}</label>
                        <input type="text" name="subheading_ar" class="form-control" value="{{ $welcome_one_items->subheading_ar }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('SubheadingKRD') }}</label>
                        <input type="text" name="subheading_krd" class="form-control" value="{{ $welcome_one_items->subheading_krd }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('TextAR') }}</label>
                        <textarea name="text_ar" class="form-control h_100" cols="30" rows="10">{{ $welcome_one_items->text_ar }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('TextKRD') }}</label>
                        <textarea name="text_krd" class="form-control h_100" cols="30" rows="10">{{ $welcome_one_items->text_krd }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Button TextAR') }}</label>
                        <input type="text" name="button_text_ar" class="form-control" value="{{ $welcome_one_items->button_text_ar }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Button TextKRD') }}</label>
                        <input type="text" name="button_text_krd" class="form-control" value="{{ $welcome_one_items->button_text_krd }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Person DesignationAR') }}</label>
                        <input type="text" name="person_designation_ar" class="form-control" value="{{ $welcome_one_items->person_designation_ar }}">
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">{{ __('Person DesignationKRD') }}</label>
                        <input type="text" name="person_designation_krd" class="form-control" value="{{ $welcome_one_items->person_designation_krd }}">
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin_welcome_one_item_element_update',$item->id) }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Heading KRD') }}*</label>
                                                    <input type="text" name="heading_krd" class="form-control" value="{{ $item->heading_krd }}" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Heading AR') }}*</label>
                                                    <input type="text" name="heading_ar" class="form-control" value="{{ $item->heading_ar }}" required>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Text AR') }}*</label>
                                                    <textarea name="text_ar" class="form-control h_70" cols="30" rows="10">{{ $item->text_ar }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Text KRD') }}*</label>
                                                    <textarea name="text_krd" class="form-control h_70" cols="30" rows="10">{{ $item->text_krd }}</textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">{{ __('Icon') }}*</label>

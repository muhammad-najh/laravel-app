...
<section class="page-title" style="background-image: url({{ asset('uploads/'.$global_setting->banner) }});">
    <div class="auto-container">
        <div class="title-outer">
            ...
            {{ $global_other_page_items->page_portfolios_title_ar }}
                        @elseif(session('sess_lang_code') == 'krd')
                        {{ $global_other_page_items->page_portfolios_title_krd }}
                        @else
                        {{ $global_other_page_items->page_portfolios_title }}
                      @endif
                ...
                <div class=" project-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="content-box">
                            ...
                            <h4 class="title"><a href="{{ route('portfolio',$portfolio->slug) }}" title="{{ $portfolio->name }}">

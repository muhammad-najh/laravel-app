...
@if($home_2_page_items->service_status == 'Show')
<section class="services-section-two">
    <div class="bg bg-pattern-12"></div>
    <div class="auto-container">
        <div class="sec-title text-center light">
            <span class="sub-title">{{ $home_2_page_items->service_subheading }}</span>
            <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->service_heading))) !!}</h2>
        </div>
...
ddddd
@if($home_2_page_items->marquee_status == 'Show')
...
@if($home_2_page_items->welcome_status == 'Show')
                    ...
                    <div class="inner-column">
                        ...
                        <div class="row">
                            ...
                            <div class="info-box col-lg-6 col-md-6">
                                <div class="inner">
                                    <h5 class="title"><i class="icon @if(session('sess_lang_direction') == 'Right to Left (RTL)') fa fa-circle-arrow-left @else fa fa-circle-arrow-right @endif"></i> {{ $item->heading }}</h5>
                                    <div class="text">
                                        {!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($item->text))) !!}
                                    </div>
                                </div>
...
@if($home_2_page_items->portfolio_status == 'Show')
<section class="projects-section pt-0">
    <div class="auto-container">
        <div class="sec-title text-center">
            <span class="sub-title">{{ $home_2_page_items->portfolio_subheading }}</span>
            <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->portfolio_heading))) !!}</h2>
        </div>
        <div class="outer-box">
            <div class="row">
                @foreach($portfolios->take($home_2_page_items->portfolio_how_many) as $portfolio)
...
@if($home_2_page_items->why_choose_status == 'Show')
...
@if($home_2_page_items->testimonial_status == 'Show')
    ...
    <div class="auto-container">
        <div class="row">
            <div class="title-column col-xl-3 col-lg-4 col-md-12">
                <div class="inner-column">
                    <div class="sec-title">
                        <span class="sub-title">{{ $home_2_page_items->testimonial_subheading }}</span>
                        <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->testimonial_heading))) !!}</h2>
                        <div class="text">{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->testimonial_text))) !!}</div>
                    </div>
                </div>
            </div>
...
@if($home_2_page_items->team_member_status == 'Show')
<section class="team-section pb-0">    
    <div class="auto-container">
        <div class="sec-title text-center">
            <span class="sub-title">{{ $home_2_page_items->team_member_subheading }}</span>
            <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->team_member_heading))) !!}</h2>
        </div>
        <div class="row">
...
@if($home_2_page_items->client_status == 'Show')
...
@if($home_2_page_items->contact_status == 'Show')
<section class="contact-section-two">
    <div class="bg bg-pattern-11"></div>
    <div class="image-box">
        <div class="image"><img src="{{ asset('uploads/'.$home_contact_photos->home_2_contact_photo) }}" alt=""></div>
            ...
            <div class="form-column col-lg-7 col-md-12">
                <div class="inner-column">
                    <div class="sec-title light">
                        <span class="sub-title">{{ $home_2_page_items->contact_subheading }}</span>
                        <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->contact_heading))) !!}</h2>
                    </div>
...
@if($home_2_page_items->blog_status == 'Show')
<section class="news-section">
    <div class="auto-container">
        <div class="sec-title text-center">
            <span class="sub-title">{{ $home_2_page_items->blog_subheading }}</span>
            <h2>{!! str_replace(["<p>", "</p>"], ["", ""], clean(nl2br($home_2_page_items->blog_heading))) !!}</h2>
        </div>
        <div class="row">
...
@if($home_2_page_items->map_status == 'Show')

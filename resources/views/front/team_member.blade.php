    ...
    <div class="auto-container">
        <div class="title-outer">
            ...
            <ul class="page-breadcrumb">
                ...
                <li><a href="{{ route('team_members') }}">
                    
                    @if(session('sess_lang_code') == 'ar')
                    {{ $global_other_page_items->page_team_members_title_ar }}
                 @elseif(session('sess_lang_code') == 'krd')
                 {{ $global_other_page_items->page_team_members_title_krd }}
                 @else
                 {{ $global_other_page_items->page_team_members_title }}
                 @endif

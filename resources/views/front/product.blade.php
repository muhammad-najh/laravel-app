...
<div class="service-details-help" style="padding: 15px; font-size: 16px; max-width: 250px;">
    ...
    <div class="help-contact">
        ...
        <a href="tel:{{ $product->phone }}" style="font-size: 16px;">{{ $product->phone }}</a>
    </div>
</div>
            ...
            <div class="col-xl-8 col-lg-8">
                <div class="services-details__content">
                    ...
                    @endif
                    <h3 class="mt-4">{{ __('Product Overview') }}</h3>
                    <div class="content mt-40">
                        ...
                        {!! clean($product->description_ar) !!}
                        @elseif(session('sess_lang_code') == 'krd')
                        {!! clean($product->description_krd) !!}
                        @else
                        {!! clean($product->description_en) !!}
                        @endif
                            </p>
                        </div>
                    </div>

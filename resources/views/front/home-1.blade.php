            ...
            <div class="row row-cols-sm-2 row-cols-md-3 row-cols-xl-5 justify-content-center">
                ...
                <div class="service-block-new-3 at-home6 col wow fadeInUp">
                    <div class="inner-box ">
                        ...
                        <h6 class="title"><a href="{{ route('servicesdetail', ['category' => $service->category, 'id' => $service->id]) }}">{{ $service->name }}</a></h6>
        ...
        <div class="row">
            ...
            <div class="service-block-new-1 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div class="inner-box">
                    ...
                    <div class="content-box">
                    <h5 class="title"><a href="{{ route('servicesdetail', ['category' => $service->category, 'id' => $service->id]) }}">{{ $service->name }}</a></h5>
                    <div class="text">

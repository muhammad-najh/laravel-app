...
class FrontController extends Controller
{
    ...
    protected $services_category;
    protected $products;
    protected $products_category;

    public function __construct()
    {
        $this->products = MyProductsCat::orderBy('name_en','asc')->get();
        $this->products_category = MySubProductsCat::with('subcategories')->get();
        // echo json_encode($this->products);
        // die();
        $this->sliders = Slider::get();
        $this->services = Service::orderBy('id','asc')->get();
        $this->services_category = MyServicesCat::with('subcategories')->get();
    ...
    public function productcat($category_name, $subcategory_name, $sub_cat_id)
    {

        $products = Product::where('category', $sub_cat_id)->get();
        ...
        return view('front.products', [
            ...
            'services_category' => $this->services_category
        ]);
    }

    public function productByCategory($id, $category)
    {
        $products = Product::where('category', $category)
            ->where('id', '!=', $id)
            ->orderBy('name_en', 'asc')
            ->get();
            $pdfs = PDFProduct::where('product_id',$id)->get();
        $product = Product::where('id', $id)
            ->where('category', $category)
            ->first();
            $products_category = MyProductsCat::with('subcategories')->get();
            
             $categoryname = MySubProductsCat::where('id',$category)->first();

            $categoryname2 = MyProductsCat::where('id',$categoryname->product_id)->first();
        ...
        return view('front.product', [
            ...
            'products_category' => $products_category,
            'services_category' => $this->services_category,
            'categoryname2'=>$categoryname2->name_en,
            'categoryname3'=>$categoryname->name_en
    ...
    public function myService(Request $request) {
        ...
        $services = Service::orderBy('name','asc')->where('category',$subcategory_id)->get();
        return view('front.services', compact('services','services_category'));
    }
    ...
    {
        // return response()->json(MyServicesCat::with('subcategories')->get()->toArray());
        // die();
    ...
    public function about()
    {
        ...
        $services_category = MyServicesCat::with('subcategories')->get();
        $products_category = MyProductsCat::with('subcategories')->get();
        $otherPageItem = OtherPageItem::first();

        return view('front.about', compact('products_category','services_category','services', 'team_members', 'welcome_one_items', 'welcome_one_item_elements','otherPageItem'));
    }
    ...
    public function services()
    {
        ...
        $services = Service::orderBy('name','asc')->get();
        return view('front.services', compact('products_category','services','services_category'));
    }


      
    
public function servicecat($category_name, $sub_cat_id)
{
    // Fetch categories and services
    $services_category = MyServicesCat::with('subcategories')->get();
    $service = Service::where('category', $sub_cat_id)->first();
    $products_category = MyProductsCat::with('subcategories')->get();
    $sub = MySubServicesCat::where('id', $sub_cat_id)->first();
    $products = MyProductsCat::orderBy('name_en', 'asc')->get();
    $subcategory = MySubServicesCat::where('id',$sub_cat_id)->first();
    $subcategory_name=$subcategory->name_en;
    $pdfs=PDFService::where('service_id', $service->id)->get();
    ...
    // After debugging, return the view
    return view('front.service', compact('category_name','subcategory_name','sub','pdfs', 'products', 'service', 'services_category', 'products_category', 'category_name'));
}


    public function serviceByCategory($id,$category)
    {
    // dd("serviceByCategory func");
        $services_category = MyServicesCat::with('subcategories')->get();
        $services = Service::orderBy('name','asc')->where('category', $category)->where('id','!=', $id)->get();
       
        $service = Service::where('id',$id)
        ->where('category', $category)
        ->first();
        $products_category = MyProductsCat::with('subcategories')->get();
        $pdfs=PDFService::where('service_id',$id)->get();

        $faqs = ServiceFaq::where('service_id',$service->id)->get();
        return view('front.service', compact('pdfs','products_category','services', 'service', 'faqs','services_category'));
    }
    ...
    public function portfolios()
    {
        ...
        return view('front.portfolios', compact('products_category','portfolios','services_category'));
    }
    ...
    public function portfolio($slug)
    {
        ...
        return view('front.portfolio', compact('products_category','services_category','portfolios', 'portfolio', 'next_slug', 'previous_slug'));
    }
    ...
    public function team_members()
    {
        ...
        $services_category = MyServicesCat::with('subcategories')->get();
        $team_members = TeamMember::orderBy('id','asc')->get();
        return view('front.team_members', compact('products_category','team_members','services_category'));
    }
    ...
    public function team_member($slug)
    {
        ...
        return view('front.team_member', compact('services_category','products_category','team_member', 'experiences'));
    }
    ...
    public function testimonials()
    {
        ...
        return view('front.testimonials', compact('products_category','testimonials','services_category'));
    }
    ...
    public function faqs()
    {
        ...
        return view('front.faqs', compact('faqs','products_category','services_category'));
    }
    ...
    public function blog()
    {
        ...
        return view('front.blog', compact('posts','products_category','services_category'));
    }
    ...
    public function post($slug)
    {
        ...
        return view('front.post', compact('services_category','products_category','latest_posts', 'post', 'post_categories', 'tags', 'post_tags'));
    }
    ...
    public function category($slug)
    {
        ...
        return view('front.category', compact('posts','products_category','services_category', 'post_category'));
    }
    ...
    public function tag($name)
    {
        ...
        $tag_name = $name;
        return view('front.tag', compact('products_category','posts', 'tag_name'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('front.search', compact('products_category','services_category','posts', 'search_by'));
    }
    ...
    public function contact()
    {
        $products_category = MyProductsCat::with('subcategories')->get();
        $services_category = MyServicesCat::with('subcategories')->get();        
        return view('front.contact',compact('products_category','services_category'));
    }
    ...
    public function contact_send_message(Request $request)
    {
        ...
        $contact = ContactUs::create([
            ...
            'datetime' => now(), // Save current timestamp
        ]);
        ...
        // \Log::info('Email sent to ' . $admin_data->email);
        return redirect()->back()->with('success', __('Message sent successfully'));
    }
    ...
    public function terms()
    {
        ...
        $products_category = MyProductsCat::with('subcategories')->get();
        $services_category = MyServicesCat::with('subcategories')->get();
        return view('front.terms', compact('products_category','services_category'));
    }
    ...
    public function privacy()
    {
        ...
        $services_category = MyServicesCat::with('subcategories')->get();
        return view('front.privacy', compact('products_category','services_category'));
